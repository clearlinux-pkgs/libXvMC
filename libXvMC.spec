...
Version  : 1.0.14
Release  : 23
URL      : https://www.x.org/releases/individual/lib/libXvMC-1.0.14.tar.gz
Source0  : https://www.x.org/releases/individual/lib/libXvMC-1.0.14.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libXvMC-1.0.14.tar.gz.sig
...
%prep
%setup -q -n libXvMC-1.0.14
cd %{_builddir}/libXvMC-1.0.14
pushd ..
cp -a libXvMC-1.0.14 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707156365
